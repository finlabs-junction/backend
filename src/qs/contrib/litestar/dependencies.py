...
from qs.contrib.litestar import constants
...
SortOrder = t.Literal["asc", "desc"]
SortOrderOrNone = SortOrder | None
PaginationTypes = t.Literal["limit_offset"]
IdentityT = t.TypeVar("IdentityT", bound=UUID | int)
ServiceT_co = t.TypeVar(
    "ServiceT_co",
    bound=SQLAlchemyAsyncRepositoryService[t.Any],
    covariant=True,
)
